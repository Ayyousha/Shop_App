...
class CategoriesItemsScreen extends StatelessWidget {
  ...
  CategoriesItemsScreen({required this.name});
  ...
  /// Body
  Widget _buildUserBody(context,state) {
    ...
    return Column(
      ...
      children: [
        ConditionalBuilder(
          condition: state is! categoryItemDataLoadingState,
          builder: (context) => ConditionalBuilder(
              condition: cubit.categoryDetailsModel!.data!.products.length > 0,
                ...
                child: RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => buildProductsItems(
                        cubit.categoryDetailsModel!.data!.products[index], context),
                  ),
                ),
              ),
            fallback: (context) =>  Expanded(
              child: Container(
                child: Column(
                  ...
                  children: [
                    Image(
                      image: NetworkImage("https://image.freepik.com/free-vector/shopping-cart-with-shopping-bag-illustration_249405-124.jpg"),
                      height: 250,
                      width: 250,
                      fit: BoxFit.cover,
                    ),
                    heightSizedBox(10),
                    Text(
                      'Unfortunately, we don\'t have this category at the moment.',
  ...
  /// Category Items
  Widget buildProductsItems(ProductsModels productsModels, context) => Column(
    children: [
            ...
            child: InkWell(
              ...
              onTap: ()
              {
                Navigator.of(context).push(
                  CustomPageRoute(
                    child : AllProductsDetailsScreen(productsModels: productsModels),
